...
var exports = {
    ...
    boot: function () {
    	$('.checkout-order-review').click(function() {
			$('.checkout-order-product-summary').toggleClass('active');
			$('.checkout-order-total-summary').toggleClass('active');
			$('.checkout-order-expand').toggleClass('active');
			$('.checkout-order-close').toggleClass('deactive');
		});
    }
