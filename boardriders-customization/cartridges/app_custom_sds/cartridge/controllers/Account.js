...
server.replace(
    ...
    function (req, res, next) {
        ...
        var editProfile = req.querystring.editProfile;
        var savePassword = req.querystring.savePassword;
        ...
        if (profileForm.valid) {
            ...
            this.on('route:BeforeComplete', function (req, res) { // eslint-disable-line no-shadow
                ...
                if (customerLogin) {
                    ...
                    res.json({
                        success: true,
                        redirectUrl: URLUtils.url('Account-Show', 'editProfile', true).toString()
                    });
                } else {
                    if (!status.error) {
        ...
        if (profileForm.valid) {
            ...
            this.on('route:BeforeComplete', function () { // eslint-disable-line no-shadow
                ...
                if (status.error) {
                    ...
                    res.json({
                        success: true,
                        redirectUrl: URLUtils.url('Account-Show', 'savePassword', true).toString()
                    });
                }
            });
        } else {
